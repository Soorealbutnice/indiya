...
<body onload="init()">
   ...
   <div class="content three_quarter">
      ...
      <div class="hoc container clear"
         ...
         <hr>
         <!-- 이미지 -->
         <form action="" method="post" id="regiform" name="regiform" enctype="multipart/form-data">
            <div class="row">
               <div class="thumbnail">
                     ...
                     <li class="services clear">
                        ...
                        <div class="three_quarter">
                           <div class="input-group">
                              <span class="input-group-addon" id="">공연날짜
                                 :&nbsp;&nbsp;</span>
            ...
            <!-- 메인 영역 끝 -->
            <div class="fl_right">
               <a href="javascript:registPerformance();" class="btn">공연 등록하기</a>
            </div>
   ...
   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyASO-TtcmYDX1eNZRtTawpGPIa_te-uhN8&signed_in=true&callback=initMap" async defer></script>
